 ...
 * limitations under the License.
 */
const It="facebook.com",bt="github.com",_t="google.com",Tt="password",Et="twitter.com",St="EMAIL_SIGNIN",kt="PASSWORD_RESET",At="RECOVER_EMAIL",Ct="REVERT_SECOND_FACTOR_ADDITION",Nt="VERIFY_AND_CHANGE_EMAIL",Dt="VERIFY_EMAIL";function xt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Rt=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(An(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(En(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Nn(t))return"Blackberry";if(Dn(t))return"Webos";if(Sn(t))return"Safari";if((t.includes("chrome/")||kn(t))&&!t.includes("edge/"))return"Chrome";if(Cn(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function En(e=B()){return/firefox\//i.test(e)}function Sn(e=B()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function kn(e=B()){return/crios\//i.test(e)}function An(e=B()){return/iemobile/i.test(e)}function Cn(e=B()){return/android/i.test(e)}function Nn(e=B()){return/blackberry/i.test(e)}function Dn(e=B()){return/webos/i.test(e)}function xn(e=B()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Rn(e=B()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(e)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(e)}function On(e=B()){return xn(e)||Cn(e)||Dn(e)||Nn(e)||/windows phone/i.test(e)||An(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Nr(e,t,n){const r=oe(e),i={requestType:"EMAIL_SIGNIN",email:t};jt(n.handleCodeInApp,r,"argument-error"),n&&Sr(r,i,n),await async function(e,t){return $n(e,t)}(r,i)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Dr(e,t){const n={identifier:t,continueUri:Ht()?Wt():"http://localhost"},{signinMethods:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Di=new Map;class xi extends Ai{async execute(){let e=Di.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Li(t),r=Pi(e);if(!await r._isAvailable())return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Di.set(this.auth._key(),e)}return this.bypassAuthState||Di.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}async function Ri(e,t){return Pi(e)._set(Li(t),"true")}function Oi(e,t){Di.set(e._key(),t)}function Pi(e){return zt(e._redirectPersistence)}function Li(e){return bn("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ts(){var e;return(null===(e=null===self||void 0===self?void 0:self.location)||void 0===e?void 0:e.protocol)||null}function Es(e=B()){return!("file:"!==Ts()&&"ionic:"!==Ts()&&"capacitor:"!==Ts()||!e.toLowerCase().match(/iphone|ipad|ipod|android/))}function Ss(e=B()){return $()&&11===(null===document||void 0===document?void 0:document.documentMode)||function(e=B()){return/Edge\/\d+/.test(e)}(e)}function ks(){try{const e=self.localStorage,t=Xr();if(e)return e.setItem(t,"1"),e.removeItem(t),!Ss()||z()}catch(e){return As()&&z()}return!1}function As(){return void 0!==t&&"WorkerGlobalScope"in t&&"importScripts"in t}function Cs(){return("http:"===Ts()||"https:"===Ts()||G()||Es())&&!(K()||j())&&ks()&&!As()}function Ns(){return Es()&&"undefined"!=typeof document}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ol{static fromPath(e){return new Ol(Dl.fromString(e))}static fromName(e){return new Ol(Dl.fromString(e).popFirst(5))}static empty(){return new Ol(Dl.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===Dl.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return Dl.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new Ol(new Dl(e.slice()))}constructor(e){this.path=e}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Td{constructor(e,t=null,n=[],r=[],i=null,s=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=r,this.limit=i,this.startAt=s,this.endAt=o,this.ft=null}}function Ed(e,t=null,n=[],r=[],i=null,s=null,o=null){return new Td(e,t,n,r,i,s,o)}function Sd(e){const t=ll(e);if(null===t.ft){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map((e=>Zh(e))).join(","),e+="|ob:",e+=t.orderBy.map((e=>{return(t=e).field.canonicalString()+t.dir;var t})).join(","),lh(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map((e=>Nh(e))).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map((e=>Nh(e))).join(",")),t.ft=e}return t.ft}function kd(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!dd(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!ed(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!$h(e.startAt,t.startAt)&&$h(e.endAt,t.endAt)}function Ad(e){return Ol.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}function Cd(e,t){return e.filters.filter((e=>e instanceof Wh&&e.field.isEqual(t)))}function Nd(e,t,n){let r=Th,i=!0;for(const n of Cd(e,t)){let e=Th,t=!0;switch(n.op){case"<":case"<=":e=Uh(n.value);break;case"==":case"in":case">=":e=n.value;break;case">":e=n.value,t=!1;break;case"!=":case"not-in":e=Th}Bh({value:r,inclusive:i},{value:e,inclusive:t})<0&&(r=e,i=t)}if(null!==n)for(let s=0;s<e.orderBy.length;++s)if(e.orderBy[s].field.isEqual(t)){const e=n.position[s];Bh({value:r,inclusive:i},{value:e,inclusive:n.inclusive})<0&&(r=e,i=n.inclusive);break}return{value:r,inclusive:i}}function Dd(e,t,n){let r=_h,i=!0;for(const n of Cd(e,t)){let e=_h,t=!0;switch(n.op){case">=":case">":e=qh(n.value),t=!1;break;case"==":case"in":case"<=":e=n.value;break;case"<":e=n.value,t=!1;break;case"!=":case"not-in":e=_h}jh({value:r,inclusive:i},{value:e,inclusive:t})>0&&(r=e,i=t)}if(null!==n)for(let s=0;s<e.orderBy.length;++s)if(e.orderBy[s].field.isEqual(t)){const e=n.position[s];jh({value:r,inclusive:i},{value:e,inclusive:n.inclusive})>0&&(r=e,i=n.inclusive);break}return{value:r,inclusive:i}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eg{setIndexManager(e){this.indexManager=e}addEntry(e,t,n){return Cg(e).put(n)}removeEntry(e,t,n){return Cg(e).delete(function(e,t){const n=e.path.toArray();return[n.slice(0,n.length-2),n[n.length-2],fm(t),n[n.length-1]]}(t,n))}updateMetadata(e,t){return this.getMetadata(e).next((n=>(n.byteSize+=t,this.Qn(e,n))))}getEntry(e,t){let n=_d.newInvalidDocument(t);return Cg(e).Z({index:"documentKeyIndex",range:IDBKeyRange.only(Ng(t))},((e,r)=>{n=this.jn(t,r)})).next((()=>n))}Wn(e,t){let n={size:0,document:_d.newInvalidDocument(t)};return Cg(e).Z({index:"documentKeyIndex",range:IDBKeyRange.only(Ng(t))},((e,r)=>{n={document:this.jn(t,r),size:og(r)}})).next((()=>n))}getEntries(e,t){let n=Pf();return this.zn(e,t,((e,t)=>{const r=this.jn(e,t);n=n.insert(e,r)})).next((()=>n))}Hn(e,t){let n=Pf(),r=new fd(Ol.comparator);return this.zn(e,t,((e,t)=>{const i=this.jn(e,t);n=n.insert(e,i),r=r.insert(e,og(t))})).next((()=>({documents:n,Jn:r})))}zn(e,t,n){if(t.isEmpty())return zl.resolve();let r=new gd(xg);t.forEach((e=>r=r.add(e)));const i=IDBKeyRange.bound(Ng(r.first()),Ng(r.last())),s=r.getIterator();let o=s.getNext();return Cg(e).Z({index:"documentKeyIndex",range:i},((e,t,r)=>{const i=Ol.fromSegments([...t.prefixPath,t.collectionGroup,t.documentId]);for(;o&&xg(o,i)<0;)n(o,null),o=s.getNext();o&&o.isEqual(i)&&(n(o,t),o=s.hasNext()?s.getNext():null),o?r.j(Ng(o)):r.done()})).next((()=>{for(;o;)n(o,null),o=s.hasNext()?s.getNext():null}))}getDocumentsMatchingQuery(e,t,n,r){const i=t.path,s=[i.popLast().toArray(),i.lastSegment(),fm(n.readTime),n.documentKey.path.isEmpty()?"":n.documentKey.path.lastSegment()],o=[i.popLast().toArray(),i.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return Cg(e).W(IDBKeyRange.bound(s,o,!0)).next((e=>{let n=Pf();for(const i of e){const e=this.jn(Ol.fromSegments(i.prefixPath.concat(i.collectionGroup,i.documentId)),i);e.isFoundDocument()&&($d(t,e)||r.has(e.key))&&(n=n.insert(e.key,e))}return n}))}getAllFromCollectionGroup(e,t,n,r){let i=Pf();const s=Dg(t,n),o=Dg(t,Bl.max());return Cg(e).Z({index:"collectionGroupIndex",range:IDBKeyRange.bound(s,o,!0)},((e,t,n)=>{const s=this.jn(Ol.fromSegments(t.prefixPath.concat(t.collectionGroup,t.documentId)),t);i=i.insert(s.key,s),i.size===r&&n.done()})).next((()=>i))}newChangeBuffer(e){return new kg(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next((e=>e.byteSize))}getMetadata(e){return Ag(e).get("remoteDocumentGlobalKey").next((e=>(ul(!!e),e)))}Qn(e,t){return Ag(e).put("remoteDocumentGlobalKey",t)}jn(e,t){if(t){const e=function(e,t){let n;if(t.document)n=vp(e.ie,t.document,!!t.hasCommittedMutations);else if(t.noDocument){const e=Ol.fromSegments(t.noDocument.path),r=mm(t.noDocument.readTime);n=_d.newNoDocument(e,r),t.hasCommittedMutations&&n.setHasCommittedMutations()}else{if(!t.unknownDocument)return cl();{const e=Ol.fromSegments(t.unknownDocument.path),r=mm(t.unknownDocument.version);n=_d.newUnknownDocument(e,r)}}return t.readTime&&n.setReadTime(function(e){const t=new Al(e[0],e[1]);return Cl.fromTimestamp(t)}(t.readTime)),n}(this.yt,t);if(!e.isNoDocument()||!e.version.isEqual(Cl.min()))return e}return _d.newInvalidDocument(e)}constructor(e){this.yt=e}}function Sg(e){return new Eg(e)}class kg extends Tg{applyChanges(e){const t=[];let n=0,r=new gd(((e,t)=>El(e.canonicalString(),t.canonicalString())));return this.changes.forEach(((i,s)=>{const o=this.Xn.get(i);if(t.push(this.Yn.removeEntry(e,i,o.readTime)),s.isValidDocument()){const a=dm(this.Yn.yt,s);r=r.add(i.path.popLast());const c=og(a);n+=c-o.size,t.push(this.Yn.addEntry(e,i,a))}else if(n-=o.size,this.trackRemovals){const n=dm(this.Yn.yt,s.convertToNoDocument(Cl.min()));t.push(this.Yn.addEntry(e,i,n))}})),r.forEach((n=>{t.push(this.Yn.indexManager.addToCollectionParentIndex(e,n))})),t.push(this.Yn.updateMetadata(e,n)),zl.waitFor(t)}getFromCache(e,t){return this.Yn.Wn(e,t).next((e=>(this.Xn.set(t,{size:e.size,readTime:e.document.readTime}),e.document)))}getAllFromCache(e,t){return this.Yn.Hn(e,t).next((({documents:e,Jn:t})=>(t.forEach(((t,n)=>{this.Xn.set(t,{size:n,readTime:e.get(t).readTime})})),e)))}constructor(e,t){super(),this.Yn=e,this.trackRemovals=t,this.Xn=new Rf((e=>e.toString()),((e,t)=>e.isEqual(t)))}}function Ag(e){return om(e,"remoteDocumentGlobal")}function Cg(e){return om(e,"remoteDocumentsV14")}function Ng(e){const t=e.path.toArray();return[t.slice(0,t.length-2),t[t.length-2],t[t.length-1]]}function Dg(e,t){const n=t.documentKey.path.toArray();return[e,fm(t.readTime),n.slice(0,n.length-2),n.length>0?n[n.length-1]:""]}function xg(e,t){const n=e.path.toArray(),r=t.path.toArray();let i=0;for(let e=0;e<n.length-2&&e<r.length-2;++e)if(i=El(n[e],r[e]),i)return i;return i=El(n.length,r.length),i||(i=El(n[n.length-2],r[r.length-2]),i||El(n[n.length-1],r[r.length-1]))
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mg{isEmpty(){return this.ns.isEmpty()}addReference(e,t){const n=new Fg(e,t);this.ns=this.ns.add(n),this.rs=this.rs.add(n)}us(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.cs(new Fg(e,t))}hs(e,t){e.forEach((e=>this.removeReference(e,t)))}ls(e){const t=new Ol(new Dl([])),n=new Fg(t,e),r=new Fg(t,e+1),i=[];return this.rs.forEachInRange([n,r],(e=>{this.cs(e),i.push(e.key)})),i}fs(){this.ns.forEach((e=>this.cs(e)))}cs(e){this.ns=this.ns.delete(e),this.rs=this.rs.delete(e)}ds(e){const t=new Ol(new Dl([])),n=new Fg(t,e),r=new Fg(t,e+1);let i=Gf();return this.rs.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Fg(e,0),n=this.ns.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}constructor(){this.ns=new gd(Fg.ss),this.rs=new gd(Fg.os)}}class Fg{static ss(e,t){return Ol.comparator(e.key,t.key)||El(e._s,t._s)}static os(e,t){return El(e._s,t._s)||Ol.comparator(e.key,t.key)}constructor(e,t){this.key=e,this._s=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cy(){return"undefined"!=typeof window?window:null}function Ny(){return"undefined"!=typeof document?document:null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ew{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new kw(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ew(this.firestore,e,this._key)}constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}}class Sw{withConverter(e){return new Sw(this.firestore,e,this._query)}constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}}class kw extends Sw{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ew(this.firestore,null,new Ol(e))}withConverter(e){return new kw(this.firestore,e,this._path)}constructor(e,t,n){super(e,t,Od(n)),this._path=n,this.type="collection"}}function Aw(e,t,...n){if(e=oe(e),fw("collection","path",t),e instanceof _w){const r=Dl.fromString(t,...n);return gw(r),new kw(e,null,r)}{if(!(e instanceof Ew||e instanceof kw))throw new dl(hl.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(Dl.fromString(t,...n));return gw(r),new kw(e.firestore,null,r)}}function Cw(e,t){if(e=vw(e,_w),fw("collectionGroup","collection id",t),t.indexOf("/")>=0)throw new dl(hl.INVALID_ARGUMENT,`Invalid collection ID '${t}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new Sw(e,null,(n=t,new xd(Dl.emptyPath(),n)));var n}function Nw(e,t,...n){if(e=oe(e),1===arguments.length&&(t=Tl.R()),fw("doc","path",t),e instanceof _w){const r=Dl.fromString(t,...n);return mw(r),new Ew(e,null,new Ol(r))}{if(!(e instanceof Ew||e instanceof kw))throw new dl(hl.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(Dl.fromString(t,...n));return mw(r),new Ew(e.firestore,e instanceof kw?e.converter:null,new Ol(r))}}function Dw(e,t){return e=oe(e),t=oe(t),(e instanceof Ew||e instanceof kw)&&(t instanceof Ew||t instanceof kw)&&e.firestore===t.firestore&&e.path===t.path&&e.converter===t.converter}function xw(e,t){return e=oe(e),t=oe(t),e instanceof Sw&&t instanceof Sw&&e.firestore===t.firestore&&jd(e._query,t._query)&&e.converter===t.converter
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){var t;t=(e,t)=>new Qb(e,t,new Hb),e.INTERNAL.registerComponent(new ae("firestore-compat",(e=>{const n=e.getProvider("app-compat").getImmediate(),r=e.getProvider("firestore").getImmediate();return t(n,r)}),"PUBLIC").setServiceProps(Object.assign({},f_))),e.registerVersion("@firebase/firestore-compat","0.3.3")}(vt);l=s("7Y9D8"),d=s("gSWVZ");vt.initializeApp({apiKey:"AIzaSyCoCV-uT6m4zkhe8p5jJA8T8Quk2bX8xX8",authDomain:"filmoteka-b315b.firebaseapp.com",projectId:"filmoteka-b315b",storageBucket:"filmoteka-b315b.appspot.com",messagingSenderId:"903917604658",appId:"1:903917604658:web:0382307da84868e996912b",measurementId:"G-WMMJWSVNYB"});const p_=JSON.parse(localStorage.getItem("account"));if(p_)document.getElementById("signin").classList.add("close"),document.getElementById("signout").classList.remove("close"),document.getElementById("googleUser").style.display="block",g_(p_.photo),document.querySelector(".firebases").insertAdjacentHTML("beforebegin",'<li><a class="nav__link nav__link--library" href="my-library.html">MY LIBRARY</a></li>');else{document.getElementById("signin").addEventListener("click",m_)}function m_(){const e=new vt.auth.GoogleAuthProvider;vt.auth().signInWithPopup(e).then((function(e){document.getElementById("signin").classList.add("close"),document.getElementById("signout").classList.remove("close"),document.getElementById("googleUser").style.display="block",g_(e.user.photoURL),document.querySelector(".firebases").insertAdjacentHTML("beforebegin",'<li><a class="nav__link nav__link--library" href="my-library.html">MY LIBRARY</a></li>'),console.log(e),localStorage.setItem("account",JSON.stringify({email:e.user.email,photo:e.user.photoURL})),d.storage.resetConstructor(),vt.auth().signOut()})).catch((function(e){console.log(e)}))}function g_(e){document.getElementById("googleUser").innerHTML=`\n          <img class="user-img" src="${e}">\n        `}document.getElementById("signout").addEventListener("click",(function(){JSON.parse(localStorage.getItem("account"))?(localStorage.removeItem("account"),document.getElementById("signin").classList.remove("close"),document.getElementById("signout").classList.add("close"),document.getElementById("googleUser").style.display="none",document.querySelector(".nav__link--library").parentNode.remove(),d.storage.resetConstructor()):(e(l).Notify.warning("➡ You have to sign in first"),console.log("➡ You have to sign in first"));document.getElementById("signin").addEventListener("click",m_)}));
//# sourceMappingURL=index.35a2f985.js.map
